  ...
  return (
    <div className="rounded-lg border border-slate-800 bg-slate-900 p-8 text-white shadow-lg">
      <div className="relative flex gap-2">
        ...
        />
        <input
          className="f-mono flex-1 rounded border border-slate-800 bg-slate-900 py-2 pl-12 pr-3 text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary"
