...
export function AssignedFilms({
  ...
  return (
    <div className="f-mono panel overflow-hidden rounded-[20px]">
      <div className="px-6 pt-5 pb-4">
        <h2 className="f-orb text-lg font-semibold leading-none text-foreground">
          {title}
        </h2>
      </div>
          ...
          return (
            <li key={film.id}>
              ...
              >
                ...
                <div
                  className={`mt-4 h-[2px] w-full rounded-full transition-colors ${
